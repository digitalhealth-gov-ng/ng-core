# NG Document Reference - Nigeria Core - FHIR Implementation Guide v0.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **NG Document Reference**

## Resource Profile: NG Document Reference 

| | |
| :--- | :--- |
| *Official URL*:https://fhir-ig.digitalhealth.gov.ng/StructureDefinition/ng-documents | *Version*:0.0.0 |
| Draft as of 2026-08-18 | *Computable Name*:NgDocuments |
