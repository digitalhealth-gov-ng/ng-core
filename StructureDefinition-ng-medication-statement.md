# NG Medication Statement - Nigeria Core - FHIR Implementation Guide v0.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **NG Medication Statement**

## Resource Profile: NG Medication Statement 

| | |
| :--- | :--- |
| *Official URL*:https://fhir-ig.digitalhealth.gov.ng/StructureDefinition/ng-medication-statement | *Version*:0.0.0 |
| Draft as of 2026-08-18 | *Computable Name*:NgMedicationStatement |
