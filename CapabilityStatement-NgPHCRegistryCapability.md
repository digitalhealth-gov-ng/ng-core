# NG PHC Registry Service Capability - Nigeria Core - FHIR Implementation Guide v0.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **NG PHC Registry Service Capability**

## CapabilityStatement: NG PHC Registry Service Capability 

| | |
| :--- | :--- |
| *Official URL*:https://fhir-ig.digitalhealth.gov.ng/CapabilityStatement/NgPHCRegistryCapability | *Version*:0.0.0 |
| Active as of 2026-08-09 | *Computable Name*:NgPHCRegistryCapability |
| *Other Identifiers:*OID:2.16.840.1.113884.3.9944.1.13.11 | |
| **Usage:**Clinical Venue:  | |

 
Minimum computable FHIR requirements for the Nigeria Core Registry Service role in primary health care facilities. 

 
Defines the computable Nigeria Core requirements for the Nigeria Core Registry Service role in primary health care facilities. Supports patient identification and facility-location discovery. 
This CapabilityStatement supports implementation, procurement, vendor onboarding, SANDBOX FHIR configuration, interoperability testing, and automated conformance assessment. A deployed server SHALL expose only capabilities actually implemented by the deployment in its runtime /metadata response. 
 ...
 [Raw OpenAPI-Swagger Definition file](NgPHCRegistryCapability.openapi.json) | [Download](NgPHCRegistryCapability.openapi.json) 

## Nigeria Core PHC Registry Service Capability
...
```json
{
  ...
  "id" : "NgPHCRegistryCapability",
  "url" : "https://fhir-ig.digitalhealth.gov.ng/CapabilityStatement/NgPHCRegistryCapability",
  "version" : "0.0.0",
  "name" : "NgPHCRegistryCapability",
  "title" : "Nigeria Core PHC Registry Service Capability",
  "status" : "active",
  "experimental" : false,
  "date" : "2026-08-09",
  "publisher" : "NDHI",
