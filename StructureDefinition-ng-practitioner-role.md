...
| Draft as of 2026-08-18 | *Computable Name*:NgPractitionerRole |
...
* Refer to this Profile: [NG TB Laboratory Register](StructureDefinition-NgTBLaboratoryRegister.md), [NG TB Specimen Shipment Register](StructureDefinition-NgTBSpecimenShipmentRegister.md), [NG Appointment](StructureDefinition-ng-appointment.md), [NG Condition](StructureDefinition-ng-condition.md)... Show 10 more, [NG DeviceRequest](StructureDefinition-ng-device-request.md), [DiagnosticReport (IPS)](StructureDefinition-ng-diagnostic-report.md), [NG Document Reference](StructureDefinition-ng-documents.md), [NG Alert Flag](StructureDefinition-ng-flag.md), [NG MedicationDispense](StructureDefinition-ng-medication-dispense.md), [NG Medication Statement](StructureDefinition-ng-medication-statement.md), [NG Laboratory or Pathology Result Observation](StructureDefinition-ng-observation-results-laboratory-pathology.md), [NG Procedure](StructureDefinition-ng-procedure.md), [NG Lightweight Provenance](StructureDefinition-ng-provenance.md) and [NG Task](StructureDefinition-ng-task.md)
