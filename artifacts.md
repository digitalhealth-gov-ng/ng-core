...
| [NG TB Quarterly DOTS and Microscopy Centre Measure](Measure-NgMeasure-TB-Quarterly-DOTS-Microscopy.md) | Defines the aggregate reporting variables in the NTBLCP/TB 18 Quarterly Report on Newly Established DOTS and Microscopy Centres.The Measure represents reporting population, newly established DOTS and AFB microscopy centres, cumulative centre counts at the beginning and end of the quarter, and population-to-centre coverage ratios.Detailed centre listings in Blocks 1 and 2 are reduced to aggregate counts and stratified by centre type for MeasureReport reporting. |
...
| | |
| :--- | :--- |
| [NG DR-TB Treatment Register](StructureDefinition-NgDRTBTreatmentRegister.md) | Logical model for the Nigeria National Tuberculosis and Leprosy Control Programme DR-TB Treatment Register. One model instance represents a DR-TB treatment register and contains repeatable patient entries covering registration, treatment initiation, diagnosis and baseline investigations, longitudinal bacteriological follow-up, TB/HIV activities and treatment outcomes. |
...
| [NG LGA/Health Facility Tuberculosis Central Register](StructureDefinition-NgTBCentralRegister.md) | Logical model for the Nigeria National Tuberculosis and Leprosy Control Programme NTBLCP/TB 08 Local Government Area/Health Facility Tuberculosis Central Register. One model instance represents a TB central register and contains repeatable patient entries covering registration, treatment initiation, disease classification, referral, bacteriological monitoring, treatment outcome and TB/HIV activities. |
| [NG TB Community and Facility Referral Register](StructureDefinition-NgTBCommunityFacilityReferralRegister.md) | Logical model for the Nigeria National Tuberculosis and Leprosy Control Programme Tuberculosis Referral Register for Community and Facility. One model instance represents one site-level monthly referral register and contains repeatable client entries covering demographics, referral date and reason, receiving facility, confirmation of TB, treatment initiation and remarks. |
| [NG TB Facility Contact Management Register](StructureDefinition-NgTBFacilityContactManagementRegister.md) | Logical model for the Nigeria National Tuberculosis and Leprosy Control Programme NTBLCP/TB 09 Facility Tuberculosis Contact Management Register. One model instance represents a facility contact-management register and contains repeatable index TB cases, each with one or more contacts followed through contact screening, TB investigation, diagnosis and treatment, eligibility for TB preventive therapy, TPT initiation, monthly drug collection and final preventive-therapy outcome. |
| [NG TB Laboratory Register](StructureDefinition-NgTBLaboratoryRegister.md) | Logical model for the Nigeria National Tuberculosis and Leprosy Control Programme NTBLCP/TB 04 TB Laboratory Register for Xpert MTB/RIF assay, AFB microscopy and other TB diagnostic tests. One model instance represents a laboratory register and contains repeatable laboratory entries corresponding to individual patient/specimen rows in the source register. |
| [NG TB Presumptive Register](StructureDefinition-NgTBPresumptiveRegister.md) | Logical model for the Nigeria National Tuberculosis and Leprosy Control Programme NTBLCP/TB 01 Presumptive TB Register for drug-susceptible and drug-resistant tuberculosis. One model instance represents one facility register reporting period and contains repeatable client entries covering registration, presumptive-TB classification, referral source, specimen processing, diagnostic investigations, HIV activities, investigation outcome and linkage to TB treatment. |
| [NG TB Specimen Shipment Register](StructureDefinition-NgTBSpecimenShipmentRegister.md) | Logical model for the Nigeria National Tuberculosis and Leprosy Control Programme NTBLCP/TB 03 Specimen Shipment Form, Version 2, 2019. One model instance represents one specimen shipment from a facility or treatment unit to a laboratory and contains repeatable specimen entries together with shipping, receipt, transport-condition and acknowledgement information. |
...
| | |
| :--- | :--- |
| [NG DR-TB Patient Discharge Questionnaire](Questionnaire-ng-drtb-patient-discharge-questionnaire.md) | Computable Questionnaire representing the Nigeria National Tuberculosis and Leprosy Control Programme NTBLCP/DR-TB 06 DR-TB In-Patient Discharge Form. It captures treatment-centre information, patient demographics and contact information, admission and discharge information, DR-TB registration and treatment initiation, comorbidities, treatment received during admission, adverse reactions, the regimen to be continued following discharge, medication supply at discharge, receiving facility and programme contacts, and responsible treatment-centre clinical personnel. |
...
| [NG TB Community and Facility Referral Questionnaire](Questionnaire-ng-tb-community-facility-referral-questionnaire.md) | Computable Questionnaire representing the Nigeria National Tuberculosis and Leprosy Control Programme NTBLCP/TB 12 Tuberculosis Referral Form for Community and Facility. It captures client identification and contact information, the referring site and referral agent, reason for referral, receiving facility information, arrival at the receiving facility, and referral outcomes including confirmation of TB diagnosis and initiation of treatment. |
| [NG TB Index Patient Contact Investigation Questionnaire](Questionnaire-ng-tb-index-patient-contact-investigation-questionnaire.md) | Computable Questionnaire representing the Nigeria National Tuberculosis and Leprosy Control Programme NTBLCP/TB 10 TB Index Patient Contact Investigation Form. It captures contact-investigator information, index TB case information, consent for contact tracing, household contacts, TB symptom screening and the outcomes and actions arising from contact investigation. |
| [NG TB Patient Referral/Transfer Questionnaire](Questionnaire-ng-tb-patient-referral-transfer-questionnaire.md) | Computable Questionnaire representing the Nigeria National Tuberculosis and Leprosy Control Programme NTBLCP/DR-TB 02 TB Patient Referral/Transfer Form. It captures patient identification, referral or transfer classification, referring and receiving facilities, TB patient classification, reason for referral, available laboratory results, HIV status, current TB and HIV medications, relevant clinical information, appointment arrangements and acknowledgement of enrolment by the receiving TB centre. |
| [NG TB Patient Treatment Card Questionnaire](Questionnaire-ng-tb-patient-treatment-card-questionnaire.md) | Computable Questionnaire representing the Nigeria National Tuberculosis and Leprosy Control Programme NTBLCP/TB 05 Tuberculosis Patient Treatment Card. It captures patient identification, disease classification, previous TB treatment history, household contacts, referral source, diagnostic results, HIV status and services, treatment monitoring, prescribed TB regimen, longitudinal treatment-adherence records, treatment-supporter information and final treatment outcome. |
| [NG TB Preventive Therapy Questionnaire](Questionnaire-ng-tb-preventive-therapy-questionnaire.md) | Computable Questionnaire representing the Nigeria National Tuberculosis and Leprosy Control Programme NTBLCP/TB 11 TB Preventive Therapy Card. It captures client or contact identification, reason for TB preventive therapy, index TB patient information where applicable, client weight, prescribed preventive-therapy regimen and dosage, longitudinal drug collection records, and final TPT outcome. |
| [NG TB Specimen Examination Request Questionnaire](Questionnaire-ng-tb-specimen-examination-request-questionnaire.md) | Computable Questionnaire representing the Nigeria National Tuberculosis and Leprosy Control Programme NTBLCP/TB 02A Specimen Examination Request Form. It captures patient identification and demographics, presumptive TB classification, disease site, HIV status, reason for examination, laboratory tests requested, specimen information, requesting health worker details and requesting facility information. |
| [NG TB Specimen Examination Result Questionnaire](Questionnaire-ng-tb-specimen-examination-result-questionnaire.md) | Computable Questionnaire representing the Nigeria National Tuberculosis and Leprosy Control Programme NTBLCP/TB 02B Specimen Examination Result Form, Version 2, 2019. It captures patient and specimen identification, requesting facility information, laboratory identification, Xpert MTB/RIF results, other diagnostic-test results, AFB smear microscopy, culture results, LPA and drug-susceptibility testing, HIV test result, laboratory remarks, and result verification and release information. |
| [NG TB Treatment Interruption Tracking Questionnaire](Questionnaire-ng-tb-treatment-interruption-tracking-questionnaire.md) | Computable Questionnaire representing the Nigeria National Tuberculosis and Leprosy Control Programme NTBLCP/TB 14 Treatment Interruption Tracking Form. It captures the patient's programme and contact information and records sequential attempts to trace a patient following treatment interruption, including the tracking method, date of tracking, date of last drug intake, whether the patient was contacted, reason for absence, proposed solution, tracking outcome and the person conducting the tracing. |
...
| [NG TB Questionnaire](StructureDefinition-ng-tb-questionnaire.md) | A Nigeria Core profile of the FHIR Questionnaire resource used to represent structured TB program forms, assessments, counselling forms, and clinical data collection instruments. |
...
| [NG TB Quarterly DOTS and Microscopy Centre Reporting Codes](CodeSystem-ng-tb-quarterly-centre-report-cs.md) | Codes used to represent the reporting variables and centre-type stratification in the NTBLCP/TB 18 Quarterly Report on Newly Established DOTS and Microscopy Centres. |
...
| [NG DR-TB Patient Discharge QuestionnaireResponse Example](QuestionnaireResponse-NgDRTBPatientDischargeQuestionnaireResponseExample.md) | Fictional DR-TB inpatient discharge response including adverse-reaction history and continuation regimen. |
...
| [NG TB Community and Facility Referral QuestionnaireResponse Example](QuestionnaireResponse-NgTBComsFacilityRefQxResponseExample.md) | Fictional closed-loop community-to-facility TB referral with diagnostic and treatment outcome. |
| [NG TB Index Patient Contact Investigation QuestionnaireResponse Example](QuestionnaireResponse-NgTBIndexPatientContactInvestigationQuestionnaireResponseExample.md) | Fictional contact-investigation response with three household contacts and different screening outcomes. |
| [NG TB Patient Referral/Transfer QuestionnaireResponse Example](QuestionnaireResponse-NgTBPatientReferralTransferQuestionnaireResponseExample.md) | Fictional completed DR-TB referral/transfer response including receiving-centre acknowledgement. |
| [NG TB Patient Treatment Card QuestionnaireResponse Example](QuestionnaireResponse-NgTBTreatmQxResponseExample.md) | Fictional longitudinal TB treatment-card response with diagnostic results, treatment monitoring, adherence records and outcome. |
| [NG TB Preventive Therapy QuestionnaireResponse Example](QuestionnaireResponse-NgTBPreventiveTherapyQuestionnaireResponseExample.md) | Fictional TPT-card response for a household contact receiving isoniazid preventive therapy with repeated drug collections. |
| [NG TB Quarterly DOTS and Microscopy Centre MeasureReport Example](MeasureReport-NgMeasureReport-TB-Quarterly-DOTS-Microscopy-001.md) | Synthetic Quarter 2, 2026 example of the NTBLCP/TB 18 quarterly report. The example demonstrates aggregate counts, centre-type stratification, cumulative centre totals and population-to-centre ratios. |
| [NG TB Specimen Examination Request Follow-up QuestionnaireResponse Example](QuestionnaireResponse-NgTBSpecimenExamQxResponseExample.md) | Fictional NTBLCP/TB 02A follow-up specimen request demonstrating the conditional follow-up month. |
| [NG TB Specimen Examination Request Questionnaire Response Example](QuestionnaireResponse-NgTBSpecimenExamRxQuestionnaireResponse.md) | Fictional completed NTBLCP/TB 02A specimen examination request for a patient with presumptive pulmonary drug-sensitive TB. Xpert/MTB/RIF and smear for AFB are requested on two sputum specimens. |
| [NG TB Specimen Examination Request QuestionnaireResponse Example](QuestionnaireResponse-NgTBSpecimenExRxQxResponseEg.md) | Fictional completed NTBLCP/TB 02A specimen examination request for a patient undergoing TB diagnosis. |
| [NG TB Treatment Interruption Tracking QuestionnaireResponse Example](QuestionnaireResponse-NgTBTreatmentInterruptionTrackingQuestionnaireResponseExample.md) | Fictional TB treatment-interruption tracing response showing three successive tracking attempts. |
