# NG Tertiary Referral Responder Capability - Nigeria Core - FHIR Implementation Guide v0.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **NG Tertiary Referral Responder Capability**

## CapabilityStatement: NG Tertiary Referral Responder Capability 

| | |
| :--- | :--- |
| *Official URL*:https://fhir-ig.digitalhealth.gov.ng/CapabilityStatement/NgTertiaryResponderCapability | *Version*:0.0.0 |
| Active as of 2026-08-09 | *Computable Name*:NgTertiaryResponderCapability |
| *Other Identifiers:*OID:2.16.840.1.113884.3.9944.1.13.18 | |
| **Usage:**Clinical Venue:  | |

 
Minimum computable FHIR requirements for the Nigeria Core Responder role in tertiary referral facilities. 

 
Defines the computable Nigeria Core requirements for the Nigeria Core Responder role in tertiary referral facilities. Supports comprehensive cross-facility and advanced referral interoperability. 
This CapabilityStatement supports implementation, procurement, vendor onboarding, SANDBOX FHIR configuration, interoperability testing, and automated conformance assessment. A deployed server SHALL expose only capabilities actually implemented by the deployment in its runtime /metadata response. 
 ...
 [Raw OpenAPI-Swagger Definition file](NgTertiaryResponderCapability.openapi.json) | [Download](NgTertiaryResponderCapability.openapi.json) 

## Nigeria Core Tertiary Referral Responder Capability
...
```json
{
  ...
  "id" : "NgTertiaryResponderCapability",
  "url" : "https://fhir-ig.digitalhealth.gov.ng/CapabilityStatement/NgTertiaryResponderCapability",
  "version" : "0.0.0",
  "name" : "NgTertiaryResponderCapability",
  "title" : "Nigeria Core Tertiary Referral Responder Capability",
  "status" : "active",
  "experimental" : false,
  "date" : "2026-08-09",
  "publisher" : "NDHI",
