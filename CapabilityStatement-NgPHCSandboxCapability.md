# NG PHC Conformance and Sandbox Capability - Nigeria Core - FHIR Implementation Guide v0.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **NG PHC Conformance and Sandbox Capability**

## CapabilityStatement: NG PHC Conformance and Sandbox Capability 
...
Minimum computable FHIR requirements for the Nigeria Core Conformance and Sandbox Service role in primary health care facilities. 

 
Defines the computable Nigeria Core requirements for the Nigeria Core Conformance and Sandbox Service role in primary health care facilities. Supports profile terminology capability and implementation validation using approved test data. 
This CapabilityStatement supports implementation, procurement, vendor onboarding, SANDBOX FHIR configuration, interoperability testing, and automated conformance assessment. A deployed server SHALL expose only capabilities actually implemented by the deployment in its runtime /metadata response. 
 ...
 [Raw OpenAPI-Swagger Definition file](NgPHCSandboxCapability.openapi.json) | [Download](NgPHCSandboxCapability.openapi.json) 

## Nigeria Core PHC Conformance and Sandbox Capability
...
```json
{
  ...
  "id" : "NgPHCSandboxCapability",
  "url" : "https://fhir-ig.digitalhealth.gov.ng/CapabilityStatement/NgPHCSandboxCapability",
  "version" : "0.0.0",
  "name" : "NgPHCSandboxCapability",
  "title" : "Nigeria Core PHC Conformance and Sandbox Capability",
  "status" : "active",
  "experimental" : false,
  "date" : "2026-08-09",
  "publisher" : "NDHI",
