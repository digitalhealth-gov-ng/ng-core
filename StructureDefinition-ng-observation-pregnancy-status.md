# Nigeria Core Pregnancy Status Observation - Nigeria Core - FHIR Implementation Guide v0.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Nigeria Core Pregnancy Status Observation**

## Resource Profile: Nigeria Core Pregnancy Status Observation 

| | |
| :--- | :--- |
| *Official URL*:https://fhir-ig.digitalhealth.gov.ng/StructureDefinition/ng-observation-pregnancy-status | *Version*:0.0.0 |
| Draft as of 2026-08-12 | *Computable Name*:NgObservationPregnancyStatus |
...
```json
{
  ...
  "title" : "Nigeria Core Pregnancy Status Observation",
  "status" : "draft",
