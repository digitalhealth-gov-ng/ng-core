# NG HIV Targeted Indication Viral Load - Nigeria Core - FHIR Implementation Guide v0.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **NG HIV Targeted Indication Viral Load**

## CodeSystem: NG HIV Targeted Indication Viral Load 

| | |
| :--- | :--- |
| *Official URL*:https://fhir-ig.digitalhealth.gov.ng/CodeSystem/ng-hiv-targeted-indication-viral-load-cs | *Version*:0.0.0 |
| Active as of 2026-08-18 | *Computable Name*:NgHivTargetedIndicationViralLoadCS |
...
```json
{
  ...
  "title" : "NG HIV Targeted Indication Viral Load",
  "status" : "active",
  "experimental" : false,
