# NG HIV-Cervical Cancer Treatment Received - Nigeria Core - FHIR Implementation Guide v0.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **NG HIV-Cervical Cancer Treatment Received**

## ValueSet: NG HIV-Cervical Cancer Treatment Received 

| | |
| :--- | :--- |
| *Official URL*:https://fhir-ig.digitalhealth.gov.ng/ValueSet/ng-hiv-cervical-cancer-treatment-received-vs | *Version*:0.0.0 |
| Active as of 2026-08-18 | *Computable Name*:NgHivCervicalCancerTreatmentReceivedVS |
...
```json
{
  ...
  "title" : "NG HIV-Cervical Cancer Treatment Received",
  "status" : "active",
  "experimental" : false,
