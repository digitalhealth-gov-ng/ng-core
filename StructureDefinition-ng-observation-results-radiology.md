...
| Draft as of 2026-08-18 | *Computable Name*:NgObservationResultsRadiology |
| *Other Identifiers:*OID:2.16.840.1.113884.3.9944.1.42.54 | |

 
A Nigeria Core Observation representing an atomic radiology result, an overall imaging conclusion, or a grouper for related radiology observations. 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ng.gov.digitalhealth.fhir-ig|current/StructureDefinition/StructureDefinition-ng-observation-results-radiology.json)
...
Other representations of profile: [CSV](StructureDefinition-ng-observation-results-radiology.csv), [Excel](StructureDefinition-ng-observation-results-radiology.xlsx), [Schematron](StructureDefinition-ng-observation-results-radiology.sch) 
...
```json
{
  ...
  "id" : "ng-observation-results-radiology",
  "url" : "https://fhir-ig.digitalhealth.gov.ng/StructureDefinition/ng-observation-results-radiology",
  "identifier" : [{
    "system" : "urn:ietf:rfc:3986",
    "value" : "urn:oid:2.16.840.1.113884.3.9944.1.42.54"
  }],
  "version" : "0.0.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "preferred",
        "valueSet" : "https://fhir-ig.digitalhealth.gov.ng/ValueSet/ng-results-radiology-observations-vs"
      }
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "preferred",
        "valueSet" : "https://fhir-ig.digitalhealth.gov.ng/ValueSet/ng-results-radiology-component-vs"
      }
    }]
  }
}
